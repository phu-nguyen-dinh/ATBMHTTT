...
-- CREATE USER C##dptest IDENTIFIED BY 123;
...
-- expdp C##ADMIN/123456@localhost:1521/<service_name> DIRECTORY=dpump_dir DUMPFILE=schema_backups.dmp LOGFILE=export_schemas.log SCHEMAS=C##dptest
...
-- impdp C##ADMIN/123456@localhost:1521/<service_name> DIRECTORY=dpump_dir DUMPFILE=schema_backups.dmp LOGFILE=export_schemas.log SCHEMAS=C##dptest
