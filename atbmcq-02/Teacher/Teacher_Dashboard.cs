...
namespace atbmcq_02
{
    public partial class Teacher_DashBoard : Form
    {
        ...
        public Teacher_DashBoard(OracleDbConnection _connect)
        {
            InitializeComponent();
        ...
        {
            var crse = new Teacher_Courses(_connection);
        ...
        {
            var opnd = new Teacher_OpenedSubjects(_connection);
        ...
        {
            var opnd = new Teacher_Student(_connection);
        ...
        {
            var opnd = new Teacher_Infor(_connection);
        ...
        {
            var opnd = new Teacher_Registration(_connection);
