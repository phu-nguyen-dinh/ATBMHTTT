...
namespace atbmcq_02
{
    public partial class Student_Registration : UserControl
    {
        public event EventHandler<OracleDbConnection> backClicked;
        public Student_Registration(OracleDbConnection _connect)
        {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            addForm.Controls.AddRange(new Control[] { lblMaMM, txtMaMM, btnSave, btnCancel });
            addForm.AcceptButton = btnSave;
            addForm.CancelButton = btnCancel;

            if (addForm.ShowDialog() == DialogResult.OK)
            {
                string masv = _connection.Username.ToUpper();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            var selectedRow = dtgvStudent.SelectedRows[0];
