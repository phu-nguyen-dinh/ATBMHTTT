...
namespace atbmcq_02
{
    public partial class PDT_DashBoard : Form
    {
        //public event EventHandler BackClicked;
        public PDT_DashBoard(OracleDbConnection _connect)
        {
            InitializeComponent();
        ...
        {
            var crse = new PDT_Courses(_connection);
        ...
        {
            var opnd = new PDT_OpenedSubjects(_connection);
        ...
        {
            var opnd = new PDT_Student(_connection);
        ...
        {
            var opnd = new PDT_Infor(_connection);
        ...
        {
            var opnd = new PDT_Registration(_connection);
